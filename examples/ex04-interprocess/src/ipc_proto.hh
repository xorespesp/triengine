...
public:
    ...
    const ipc_proto::packet_header_t* header() const noexcept {
        return _XUTL utility::bit_cast<ipc_proto::packet_header_t*>(_pck_buff.data());
    }
    ...
    const _PckBody* body() const noexcept {
        return _XUTL utility::bit_cast<_PckBody*>(_pck_buff.data() + sizeof(ipc_proto::packet_header_t));
    }
...
public:
    ...
    const _PckBody* body() const noexcept
    {
        ...
        return _XUTL utility::bit_cast<const _PckBody*>(_data_view.data() + sizeof(ipc_proto::packet_header_t));
    }

    const uint8_t* data() const noexcept {
        return _XUTL utility::bit_cast<const uint8_t*>(_data_view.data());
    }
...
private:
    inline const ipc_proto::packet_header_t* _header() const noexcept {
        return _XUTL utility::bit_cast<ipc_proto::packet_header_t*>(_data_view.data());
    }
    ...
    inline bool _validate_format() const noexcept
    {
        ...
        const auto header = _XUTL utility::bit_cast<const ipc_proto::packet_header_t*>(_data_view.data());
