// Texture-Shaded Unlit Mesh Object Fragment Shader (forward transparent pass)
...
void main()
{
    // Unlit: use the base color directly (no lighting applied).
    const vec3 baseColor = texture(u_diffuseMap, fsi.texCoords).rgb;
